...
| ⚙️ **Backend REST API** | Render | [https://mini-erp-crm-operations-portal-z3uy.onrender.com/api/v1/health](https://mini-erp-crm-operations-portal-z3uy.onrender.com/api/v1/health) |
