        ...
        <div className="glass-card rounded-2xl p-8 border border-slate-800 shadow-2xl space-y-6">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <Button type="submit" variant="primary" className="w-full py-3" isLoading={isSubmitting}>
              <Lock className="h-4 w-4 mr-2" /> Sign In to Portal
            </Button>
          </form>
          ...
          <div className="pt-4 border-t border-slate-800/80 space-y-3">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="px-3 py-2 rounded-lg bg-purple-950/40 border border-purple-800/50 hover:bg-purple-900/60 text-purple-300 text-xs font-semibold flex items-center justify-between transition-colors"
              >
                <span>Admin</span>
              ...
              <button
                ...
                className="px-3 py-2 rounded-lg bg-sky-950/40 border border-sky-800/50 hover:bg-sky-900/60 text-sky-300 text-xs font-semibold flex items-center justify-between transition-colors"
              >
                <span>Sales</span>
              ...
              <button
                type="button"
                onClick={() => handleDemoFill('warehouse@demo.com', 'WAREHOUSE')}
                className="px-3 py-2 rounded-lg bg-amber-950/40 border border-amber-800/50 hover:bg-amber-900/60 text-amber-300 text-xs font-semibold flex items-center justify-between transition-colors"
              >
                <span>Warehouse</span>
              ...
              <button
                type="button"
                onClick={() => handleDemoFill('accounts@demo.com', 'ACCOUNTS')}
                className="px-3 py-2 rounded-lg bg-emerald-950/40 border border-emerald-800/50 hover:bg-emerald-900/60 text-emerald-300 text-xs font-semibold flex items-center justify-between transition-colors"
              >
                <span>Accounts</span>
